...
public class Main {
    ...
    public static void recursive(int n) {
        ...
        System.out.println(underBar.repeat(n) + str1);
        System.out.println(underBar.repeat(n) + str2);
        System.out.println(underBar.repeat(n) + str3);
        System.out.println(underBar.repeat(n) + str4);
        ...
        System.out.println(underBar.repeat(n) + str6);
